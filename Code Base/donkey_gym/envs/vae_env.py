...
from config import INPUT_DIM, MIN_STEERING, MAX_STEERING, JERK_REWARD_WEIGHT, MAX_STEERING_DIFF, DONKEY_SIM_PATH
...
class DonkeyVAEEnv(gym.Env):
    ...
    def __init__(self, level=0, frame_skip=2, vae=None, const_throttle=None,
        ...
        exe_path = os.environ.get('DONKEY_SIM_PATH', DONKEY_SIM_PATH)
        if exe_path is None:
